...
void wormsim::set_steering_synapse_weight(int synapse, double weight)
{
	switch(synapse)
	{
		case ASEL0:
...
double wormsim::get_steering_activation(int neuron)
{
	switch(neuron)
	{
		case ASEL:
...
double wormsim::get_dorsal_motor_activation(int segment)
{
    return V_neuron[segment][0];
}

// Get ventral motor neuron activation.
double wormsim::get_ventral_motor_activation(int segment)
{
...
double wormsim::get_dorsal_muscle_activation(int segment)
{
	return dorsal_muscle_activations[segment];
}
double wormsim::get_ventral_muscle_activation(int segment)
{
...
double wormsim::get_segment_angle(int segment)
{
    return segment_angles[segment];
}

// Get body point.
double wormsim::get_body_point(int index)
{
	return yval[index];
}
...
int wormsim::init()
{
	...
	std::cout << "wormsim simulation init" << std::endl;
...
void wormsim::step(double salt_stimulus)
{
